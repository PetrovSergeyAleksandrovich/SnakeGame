...
void ASnakeBase::AddSnakeElement(int ElementsNum)
{
	for (int i = 0; i < ElementsNum; i++)
	{
		...
		//auto NewSnakeElem = GetWorld()->SpawnActor<ASnakeElementBase>(ASnakeBase::SnakeElementClass, NewTransform);
		ASnakeElementBase* NewSnakeElem = GetWorld()->SpawnActor<ASnakeElementBase>(ASnakeBase::SnakeElementClass, NewTransform);
